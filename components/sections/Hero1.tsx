						...
						<div className="col-lg-6 col-md-12 mb-lg-0 mb-5">
							<div className="pe-2">
								{data?.badge?.visible !== false && (
									<Link href={data?.badge?.link || "#"} className="d-flex align-items-center bg-linear-1 d-inline-flex rounded-pill px-2 py-1" style={{backgroundColor: data?.badge?.backgroundColor || ''}}>
						...
						<div className="col-lg-6 position-relative justify-content-center">
							...
							{data?.card?.visible !== false && (
								<div className="alltuchtopdown card-hero backdrop-filter rounded-3 text-center d-inline-block p-3 position-absolute" style={{backgroundColor: data?.card?.backgroundColor || ''}}>
									...
									<p className="fs-7 text-700" style={{color: data?.card?.descriptionColor || ''}}>
										{data?.card?.description || ""}
									</p>
									<Link href={data?.card?.button?.link || "#"} className="shadow-sm d-flex align-items-center bg-white d-inline-flex rounded-pill px-2 py-1 mb-3" style={{backgroundColor: data?.card?.button?.backgroundColor || ''}}>
										...
										<span className="fs-7 fw-medium text-primary mx-2" style={{color: data?.card?.button?.textColor || ''}}>
