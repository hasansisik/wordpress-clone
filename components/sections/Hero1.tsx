					...
					<div className="row content align-items-center">
						<div className="col-lg-6 col-md-12 mb-lg-0 mb-5">
							<div className="pe-2">
								<Link href={data.badge?.link || "#"} className="d-flex align-items-center bg-linear-1 d-inline-flex rounded-pill px-2 py-1">
									<span className="bg-primary fs-9 fw-bold rounded-pill px-2 py-1 text-white">{data.badge.label}</span>
									<span className="fs-7 fw-medium text-primary mx-2">{data.badge.text}</span>
								...
								<h3 className="ds-3 mt-4 mb-5" data-aos="fade-zoom-in" data-aos-delay={0}>{data.title}</h3>
								<p className="pe-10 mb-5" data-aos="fade-zoom-in" data-aos-delay={200}>{data.description}</p>
						...
						<div className="col-lg-6 position-relative justify-content-center">
							...
							<div className="alltuchtopdown card-hero backdrop-filter rounded-3 text-center d-inline-block p-3 position-absolute">
								...
								<h6 className="mt-3">{data.card.title}</h6>
								<p className="fs-7 text-700">{data.card.description}</p>
								<Link href={data.card.button.link} className="shadow-sm d-flex align-items-center bg-white d-inline-flex rounded-pill px-2 py-1 mb-3">
									<span className="bg-primary fs-9 fw-bold rounded-pill px-2 py-1 text-white">{data.card.button.label}</span>
									<span className="fs-7 fw-medium text-primary mx-2">{data.card.button.text}</span>
									<svg xmlns="http://www.w3.org/2000/svg" width={18} height={19} viewBox="0 0 18 19" fill="none">
