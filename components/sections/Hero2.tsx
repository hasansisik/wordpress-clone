          ...
          <div className="swiper-wrapper">
											...
											<div className="col-lg-6">
												<div className="backdrop-filter p-8 position-relative rounded-3">
													...
													<div className="d-flex flex-column flex-md-row align-items-center">
														<Link href="#" className="btn btn-gradient rounded-4 d-flex align-items-center">
															View Our Services
            ...
            <SwiperSlide className="swiper-slide">
              <div
                ...
                style={{
                  backgroundImage: `url(/assets/imgs/hero-5/img-bg-2.png)`,
                }}
              >
                <div className="container position-relative z-2">
                  <div className="row">
                    <div className="col-lg-6">
                      <div className="backdrop-filter p-8 position-relative rounded-3">
                        ...
                        <h3 className="ds-3 my-3">
                          Best Solutions for Innovation
                        </h3>
                        <p className="fs-5 text-900">
                          Infinia offers full range of consultancy training
                          methods for business consultation.
                        </p>
                        <div className="d-flex flex-column flex-md-row align-items-center">
                          <Link href="#" className="btn btn-gradient rounded-4 d-flex align-items-center">
                            View Our Services
