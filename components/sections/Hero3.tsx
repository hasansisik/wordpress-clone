						...
						<div className="col-lg-7 position-relative z-1 mb-lg-0 pb-10 mb-">
							<div className="text-start mb-lg-0 mb-5">
								<div className="border-linear-1 rounded-pill d-inline-block mb-3">
									<div className="text-primary bg-white px-4 py-2 rounded-pill fw-medium position-relative z-2">{data.badge.text}</div>
								</div>
								<div className="d-flex align-items-center">
									<h1 className="ds-1 my-3 me-4 lh-1">{data.title.part1}</h1>
								...
								<h1 className="ds-1 lh-1 m-0">{data.title.part2}</h1>
								<p className="fs-5 text-900 my-6">{data.description}</p>
