										...
										<div className="row mt-5">
											...
											<div className="col-12 d-flex justify-content-center justify-content-md-start">
												<div className="input-group d-flex mt-4" style={{ maxWidth: '100%', width: '100%' }}>
													...
													<textarea className="form-control border border-start-0 ms-0 rounded-start-0 rounded-1 pb-10" name="message" placeholder="Briefly Describe Your Message" aria-label="With textarea" required></textarea>
												</div>
											</div>
