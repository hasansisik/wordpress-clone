									...
									<form onSubmit={handleSubmit}>
										<div className="row mt-5">
											...
											<div className="col-12 ">
												<button 
													type="submit" 
													className="btn text-white hover-up mt-4 d-flex align-items-center justify-content-center" 
													style={buttonStyle}
									...
									<div className="ps-lg-6">
										{data.showEmail && (
											<>
												...
												<p className="text-500">{data.emailDescription}</p>
										...
										{data.showPhone && (
											<>
												...
												<p className="text-500">{data.inquiryDescription}</p>
