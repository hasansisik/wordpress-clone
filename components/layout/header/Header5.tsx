									...
									if (item.name === "Email" && item.content) {
										return (
											<a href={`mailto:${item.content}`} className="pe-4 d-none d-md-flex" key={index}>
												...
												<span className="text-white ps-1 fs-7">{item.content}</span>
											</a>
										)
									}
